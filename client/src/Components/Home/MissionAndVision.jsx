...
const MissionAndVision = () => {
    return (
        <div className="py-10 bg-purple-700">
            <div className="container mx-auto text-center">
                <h1 className="text-4xl font-bold text-white mb-8">Misión y Visión</h1>
                <div className="flex flex-col md:flex-row items-center justify-center gap-10">
                    <div className="w-72 h-72 bg-purple-500 text-white flex flex-col items-center justify-center rounded-full shadow-lg p-6">
